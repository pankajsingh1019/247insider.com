 ...
 */
    ...
    private $_data_sp = array();
    
	public function fetchAll($sql, $params = array(), $cache = true, $modelName = null) {
		...
		if ($this->execute($sql, array(), $params)) {
            ...
            if(isset($this->_data_sp) && is_array($this->_data_sp) && !empty($this->_data_sp)){
                return $this->_data_sp;
            }
    ...
    //Added this function to use custom function executeSP if at all any params are supplied
    public function execute($sql, $options = array(), $params = array()) {
		$options += array('log' => $this->fullDebug);

		$t = microtime(true);
        if(is_array($params) && !empty($params)){
            $sp_return_object = $this->_executeSP($sql, $params);
            $this->_result = $sp_return_object['resource'];
            $this->_data_sp   = $sp_return_object['data'];
        }else{
