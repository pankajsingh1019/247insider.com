...
<div class="compare-cards">
    ...
    <div class="card one">
        ...
        <div class="compare-ratings">
            <div>
                ...
                <?php echo $this->Html->image('prodRating.png'); ?>
            </div>
        ...
        <div class="compare-button">
            <a <?php echo $product->anchorAttributes; ?> href="<?php echo $product->clickUrl ?>" target="_blank">
    ...
    <div class="card one">
        ...
        <div class="compare-button">
            <a <?php echo $fakeStore->anchorAttributes; ?> href="<?php echo $fakeStore->clickUrl ?>" target="_blank">
                <div class="btn"> BUY NOW</div>
            </a>
        </div>
